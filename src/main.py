...
async def main_app():
    ...
    try:
        ...
        # 2. Obtener período del usuario
        periodo = int(input(f"{Colors.INPUT}Período (segundos): \033[0m") or 60)

        # 3. Inicializar componentes con el período
        analizador = AnalizadorTecnico(periodo)
